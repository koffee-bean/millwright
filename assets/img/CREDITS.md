...
Photos from [Unsplash](https://unsplash.com), used under the [Unsplash License](https://unsplash.com/license). Credit is not required, but here is who took them.

The originals are in `_src/photos/`. `python3 _src/photos.py` crops and tints them into the WebP files in this folder.
...
| `service-head-of-data` | Kelly Sikkema | [Unsplash](https://unsplash.com/photos/doS_ZDtfjzw) |
| `industry-semiconductor` | Laura Ockel | [Unsplash](https://unsplash.com/photos/qOx9KsvpqcM) |
| `industry-healthcare` | Nate Mindful | [Unsplash](https://unsplash.com/photos/H8FWz4_e-ng) |
| `industry-hospitality` | Andrew Neel | [Unsplash](https://unsplash.com/photos/B4rEJ09-Puo) |
| `industry-games` | Vitalii Abakumov | [Unsplash](https://unsplash.com/photos/UCXxAKedX7k) |
...
| `writing-do-we-need-a-semantic-layer-before-ai` | Clark Van Der Beken | [Unsplash](https://unsplash.com/photos/A1AV-H8ZBaM) |
| `writing-when-to-hire-a-fractional-head-of-data` | Annie Spratt | [Unsplash](https://unsplash.com/photos/2pia6OAe5rA) |
| `writing-is-our-data-ready-for-ai` | Markus Winkler | [Unsplash](https://unsplash.com/photos/Q2J2qQsoYH8) |
